const PATHS = {
  ...
  stethoscope: <><path d="M6 2v6a3 3 0 0 0 6 0V2"/><path d="M9 14v3a4 4 0 0 0 8 0v-1"/><circle cx="18" cy="11" r="2"/></>,
  ...
  mic: <><rect x="9" y="2" width="6" height="11" rx="3"/><path d="M19 10a7 7 0 0 1-14 0M12 19v3"/></>,
  sparkle: <><path d="M12 3 13.5 9 19.5 10.5 13.5 12 12 18 10.5 12 4.5 10.5 10.5 9 12 3Z"/></>,
  trash: <><path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6"/></>,
  ...
  badge: <><path d="M3 21h18M5 21V7l8-4 8 4v14M9 9h.01M9 12h.01M9 15h.01M9 18h.01"/></>,
